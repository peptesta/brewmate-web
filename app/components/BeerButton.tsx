...
const Button = () => {
  return (
    <StyledWrapper>
      {/* type="button" evita che il form si invii per errore se non vuoi */}
      <button type="submit">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
          <path
            style={{ fill: "#363636" }}
            d="M17.1,21a1,1,0,0,1-1-.945C16.036,18.754,16,17.39,16,16a1,1,0,0,1,2,0c0,1.354.035,2.681.1,3.945A1,1,0,0,1,17.159,21Z"
          />
          <path
            style={{ fill: "#363636" }}
...
const StyledWrapper = styled.div`
  button {
    ...
    width: 45px; /* Dimensioni fisse per stare nell'input */
    height: 45px;
    position: relative;
    overflow: hidden;
    border-radius: 50%;
    transition: all 0.3s ease;
    box-shadow: none; /* Rimosso ombra */
  }

  button svg {
    width: 30px; /* Ridimensionato l'SVG */
    height: 30px;
